...
const AdminCourseCreate = ({ isOpen, onClose, onSuccess }) => {
  const { user } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Crear el curso
      const newCourse = await courseService.createCourse(sanitizedData);

      // Registrar auditoría
      await courseService.logAdminAction('create_course', newCourse.id, user.id, {
      ...
      showError(`Error al crear el curso: ${errorMessage}`);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="flex items-center justify-between mb-6 pb-4 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-gray-600">Complete la información para crear un nuevo curso</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-sm text-gray-500">
              {Object.keys(errors).length === 0 ? 'Completado' : `${Object.keys(errors).length} errores`}
            </span>
          </div>
          ...
          {errors.submit && (
            <div className="bg-red-50 border border-red-200 rounded-md p-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">Error al crear el curso</h3>
          ...
          <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
            <div className="relative top-4 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
              <div className="flex items-center justify-between mb-4 pb-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">Vista Previa del Curso</h3>
                <button
